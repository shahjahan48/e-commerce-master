...
<!-- jQuery UI 1.11.4 -->
<script src="<c:url value="/assets/plugins/jquery-ui/jquery-ui.min.js" />"></script>
...
<!-- ChartJS -->
<script src="<c:url value="/assets/plugins/chart.js/Chart.min.js" />"></script>
<!-- Sparkline -->
...
<script src="<c:url value="/assets/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js" />"></script>
<!-- Summernote -->
<script src="<c:url value="/assets/plugins/summernote/summernote-bs4.min.js" />"></script>
<!-- overlayScrollbars -->
<script src="<c:url value="/assets/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js" />"></script>
<!-- AdminLTE App -->
